...
router.post('/lession', checkauth, getLogedInUser, uploadPDF.array('file'),lession.create)
...
router.put('/lession/:lessionId', checkauth, getLogedInUser,uploadPDF.single('file'), lession.update);
